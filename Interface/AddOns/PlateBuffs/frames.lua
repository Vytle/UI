...
--~ 	self.skin:Hide()
	...
	if P.showCooldown == true and self.expirationTime > 0 then
		...
		if P.showCooldownTexture == true then
			...
			self.cdtexture:SetCooldown(cdtexturetimer, self.duration, true);
		else
			self.cdtexture:Hide()
		end
...
--~ 	f.border:SetPoint("CENTER", f.icon)
	...
	f.border:SetTexture("Interface\\Buttons\\UI-Debuff-Overlays") --Interface\\Buttons\\UI-Debuff-Overlays
