...
--
-- Copyright 2012-2013 BeathsCurse (Saphod - Draenor EU)
--
...
function panel:Initialize()
	...
	local controlCheckBoxEnabled = self:CreateCheckBox(
		...
		true)
	controlCheckBoxEnabled:SetPoint('TOPLEFT', 16, -76)

	local controlHeadingSolo = self:CreateHeading('When Solo')
	controlHeadingSolo:SetPoint('TOPLEFT', controlCheckBoxEnabled, 'BOTTOMLEFT', 0, -32)
	...
	controlHeadingInstance:SetPoint('TOPLEFT', controlDropDownSoloOwn, 'BOTTOMLEFT', 0, -24)
	...
	controlHeadingGroup:SetPoint('TOPLEFT', controlDropDownInstanceOwn, 'BOTTOMLEFT', 0, -24)
	...
	controlHeadingRaid:SetPoint('TOPLEFT', controlDropDownGroupOwn, 'BOTTOMLEFT', 0, -24)
	...
	controlTextExplain:SetPoint('TOPLEFT', controlDropDownRaidOwn, 'BOTTOMLEFT', 0, -32)
